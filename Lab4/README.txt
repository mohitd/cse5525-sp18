...
For this project we used the Keras framework, to install run pip install keras or conda install keras depending on your environment.
...
Python file. The model will begin to run and TensorBoard will show your progress through the epochs in the interpreter window. 

Results: 
For part A we used the glove word embeddings with a single LSTM layer -> Max Pooling layer -> Dense Layer. Below are the results:
...
2-layer GRU-512 GRU-256     Accuracy: 0.2405
